...
import { createPostAction } from "../../redux/slices/postsSlice";
...
export default function CreatePost() {
  ...
  const { isPostCreated, loading, appErr, serverErr } = state;
      ...
      <div className="min-h-screen bg-gray-400 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <div className="mt-2 text-center text-sm text-gray-600">
            <p className="font-medium text-1xl text-gray-900 hover:text-indigo-500">
              Convert your ideas into words. Your post must be free from
              profanity
            </p>
          </div>
          {appErr || serverErr ? (

...
import { verifyAccountAction } from "../../redux/slices/accountVerificationSlice";
...
export default function AccountVerified({
  ...
  const accountVerification = useSelector((state) => state.accountToken);
  const { verifiedAccount, isVerified } = accountVerification;

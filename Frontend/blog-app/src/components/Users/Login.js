...
const Login = () => {
  ...
  const { userAuth, loading, appErr, serverErr } = userData;
  ...
  return (
    <>
      <section className="min-h-screen relative py-20 2xl:py-40 bg-gray-400 overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="flex flex-wrap items-center -mx-4">
              <div className="w-full lg:w-2/5 px-4">
                <div className="px-6 lg:px-12 py-12 lg:py-24 bg-gray-900 shadow-lg rounded-lg">
                  {/* Form */}

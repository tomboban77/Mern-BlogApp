...
import { sendMailAction } from "../../redux/slices/emailSlice";
...
const SendEmail = ({ location: { state } }) => {
  ...
  const mailInfo = useSelector((mailInfo) => mailInfo.sendMail);
  const { isMailSent, loading, appErr, serverErr } = mailInfo;
